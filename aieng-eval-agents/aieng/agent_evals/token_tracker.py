"""Shared token usage tracking for Gemini ADK agents.

This module provides utilities for tracking token usage and context
window consumption during agent execution. It is used by all ADK-based
agents in this package (e.g. summarization, entity extraction).
"""
